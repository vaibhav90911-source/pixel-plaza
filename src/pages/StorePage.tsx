...
const storeItems = [
  {
    ...
    icon: Crown,
    items: [
      { name: "Elite", price: "₹40", desc: "Basic perks, colored name, /fly in lobby", color: "text-green-400" },
      { name: "Champion", price: "₹80", desc: "All Elite perks + /nick, particle effects, priority queue", color: "text-blue-400" },
      ...
      { name: "Ace", price: "₹999", desc: "All Deadliest perks + monthly crate, /fly survival, all cosmetics", color: "text-yellow-400" },
      { name: "Boss", price: "₹1,499", desc: "All Ace perks + weekly beast crate, /god PvE, priority support", color: "text-orange-400" },
